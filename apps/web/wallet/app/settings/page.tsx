...
export default function SettingsPage() {
  ...
  const [walletName, setWalletName] = useState('My KuberCoin Wallet');
                ...
                <div className={styles.section}>
                  ...
                  <div className={styles.form}>
                    <Input
                      ...
                      icon={<span>💼</span>}
                      hint="Display name for this wallet"
                    />
                ...
                <div className={styles.section}>
                  ...
                  <div className={styles.backupStatus}>
                    <div className={styles.backupInfo}>
                      ...
                      <div>
                        <h4>Last Backup</h4>
                        <p>3 days ago (Jan 30, 2026)</p>
                      </div>
                    </div>
                    <Badge variant="warning">Backup Recommended</Badge>
                  </div>
                  ...
                  <div className={styles.backupActions}>
                    ...
                    <Button variant="outline" icon={<span>📥</span>} fullWidth>
                      Restore from Backup
                    </Button>
                  </div>
                  ...
                  <div className={styles.recoveryPhrase}>
                    ...
                    <p>Your 12-word recovery phrase is the master key to your wallet</p>
