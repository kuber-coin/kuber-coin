...
export default function KeyManagerPage() {
  ...
  const generateMnemonic = () => {
    alert('Mnemonic generation requires a key-management backend.');
  };
  ...
  const importWallet = () => {
    ...
    alert('Mnemonic import requires a key-management backend.');
  };
                ...
                <div className={styles.section}>
                  ...
                  <div className={styles.warningBox}>
                    ...
                    <div>
                      ...
                      <p>For security, Kuber only exports encrypted wallet files. Never share your encryption password.</p>
                    </div>
                  </div>
